...
function calculateSalesTaxAndTotalPrice(a, b)
{
    ...
    document.getElementById(2).value = salesTaxAmount.toFixed(2);
...
function calculateYearBornFromCurrentYear(a)
{
    ...
    document.getElementById(1).textContent = currentYear;
...
function calculateMeanAverageOfNumbers()
{
    ...
    let numbersArray = document.getElementById(0).value.split(',');
